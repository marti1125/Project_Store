...
public class EntradasDeProductos extends CRUD{
	
	public static void listar() throws Exception {
		List<EntradaDeProducto> entradaDeProducto = EntradaDeProducto.findAll();
		org.codehaus.jackson.map.ObjectMapper mapper = new ObjectMapper();		
		renderJSON(mapper.writeValueAsString(entradaDeProducto));		
	}
	...
	public static void create() throws Exception {
        ...
        productoDetalle =  productoDetalle.findById(entradaDeProducto.productoDetalle.id);        
